...
import com.gentle.store.inventory.security.Role;
import com.gentle.store.inventory.util.Constants;
    ...
    default SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
            .authorizeHttpRequests(authorize -> {
                final var restPathKundeId = STR."\{Constants.INVENTORY_PATH}/*";
                authorize
                        .requestMatchers(GET, Constants.INVENTORY_PATH).hasRole(Role.ADMIN.name())
