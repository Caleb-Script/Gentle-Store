package com.gentle.store.order.config;

import com.gentle.store.order.security.Role;
    ...
    default SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
            .authorizeHttpRequests(authorize -> {
                final var restPathKundeId = STR."\{Constants.ORDER_PATH}/*";
                authorize
                        .requestMatchers(GET, Constants.ORDER_PATH).hasRole(Role.ADMIN.name())
